...
export default function Header({ user }: HeaderProps) {
  ...
  return (
    <header
      className={combine(
        "fixed w-full top-0 z-50 lg:py-4 lg:px-8 flex items-center min-h-16 lg:h-36 bg-opacity-95 dark:bg-cake-950 bg-cake-200 transition-all ease-linear duration-200",
