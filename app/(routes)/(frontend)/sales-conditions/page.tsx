...
export default function SalesConditionsPage() {
  return (
    <Container className="py-12 prose-base">
      <Headline>Condiciones de venta, envío y devolución</Headline>
      <p>
      ...
      <div>
        ...
        <div>
          ...
          <p>Para la adquisición de los productos ofertados se deberán seguir los siguientes pasos:</p>
          <p>
          ...
          <p>Inicio del proceso de compra: para iniciar el proceso de compra pulse el botón “Finalizar Compra”. Se pedirá que facilite sus datos de facturación y la fecha de entrega.</p>
          <p>Verificación de los datos de la compra: Previamente a realizar el pago podrá verificar los datos de su compra y corregir cualquier error producido en la introducción de datos.</p>
          <p>
            Selección del medio de pago: Introduzca los datos de su tarjeta bancaria. Este será el único momento en que se le solicitará esta información.
        ...
        <div>
          ...
          <p>Las tartas llegarán a su domicilio tal y como aparece en la web y con el tamaño solicitado. En El horno de la abuelita Maruja, no escribimos sobre las tartas.</p>
          <p>Las tartas están elaboradas el día de antes para que lleguen recién hechas a sus domicilios y se mantienen en nevera en perfecto estado hasta 4 días después de su recepción.</p>
          <p>
          ...
          <p>Los cupones de descuento se pueden aplicar a toda la web menos a productos ya en promoción y NOVEDADES.</p>
          <p>
        ...
        <div>
          ...
          <p>Dada la particularidad del tipo de transporte de frio que necesitan los productos comercializados en la web, El horno de la abuelita Maruja sólo puede ofrecer envío a España peninsular.</p>
          <p>
          ...
          <p>Los pedidos realizados con envío Valencia y Alicante antes del 13.00h pueden ser entregados en 24h (Ejemplo: si pides un lunes antes de las 13.00h, el pedido se podrá entregar el martes).</p>
          <p>
        ...
        <div>
          ...
          <p>Durante el proceso de compra, podrás ver el gasto concreto del envío dependiendo del código postal seleccionado para la entrega.</p>
          <p>
        ...
        <div>
          ...
          <p>Si el cliente lo desea podrá recoger su pedido, sin coste adicional, en cualquiera de nuestras tiendas físicas:</p>
          <ul className="list-disc pl-12">
        ...
        <div>
          ...
          <p>Los productos comercializados en El horno de la abuelita Maruja quedan excluidos del derecho de desistimiento en base a las siguientes excepciones incluidas en el artículo 103 del Texto Refundido de los Consumidores y Usuarios:</p>
          <ul className="list-disc pl-12">
            <li>
