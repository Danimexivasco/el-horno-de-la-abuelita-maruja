...
export default function LegalPage() {
  return (
    <Container className="py-12">
      <Headline className="mb-12">Aviso Legal</Headline>
      <div className="grid gap-8">
        ...
        <div>
          ...
          <p>El usuario responderá de los daños y perjuicios de toda naturaleza que El Horno de la Abuelita Maruja pueda sufrir, con ocasión del incumplimiento de cualquiera de las obligaciones anteriormente expuestas así como cualesquier otras incluidas en las presentes Condiciones Generales y/o las impuestas por la Ley en relación con la utilización del Sitio Web.</p><br />
          <p>Todo usuario menor de edad deberá utilizar la Web bajo el consentimiento de su padre, madre o tutor legal, siendo estos los responsables de cualquier problema que pudiera acontecer en el uso de los servicios de la misma.</p><br />
        ...
        <div>
          ...
          <ol className="grid gap-4 list-decimal pl-12 py-4">
        ...
        <div>
          ...
          <p>El Horno de la Abuelita Maruja se reserva el derecho a interrumpir el acceso a los servicios en cualquier momento y sin previo aviso, ya sea por motivos técnicos, de seguridad, de control, de mantenimiento, por fallos de suministro eléctrico o por cualquier otra causa justificada.</p><br />
          <p>En consecuencia, El Horno de la Abuelita Maruja no garantiza la fiabilidad, la disponibilidad ni la continuidad de la Web ni de los Servicios, por lo que la utilización de los mismos por parte de los usuarios se lleva a cabo por su propia cuenta y riesgo, sin que, en ningún momento, puedan exigirse responsabilidades a El Horno de la Abuelita Maruja en este sentido.</p><br />
