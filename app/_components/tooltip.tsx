...
export default function Tooltip({ text, className="" } : TooltipProps) {
  return (
    <div
      className={combine(
        "absolute w-fit whitespace-nowrap bg-black/95 rounded-lg px-2 py-1.5 top-1/2 -translate-y-1/2 left-[110%] opacity-0 peer-hover:opacity-100 transition-all ease-linear duration-100 text-white shadow-md shadow-black/30",
        className
      )}>
