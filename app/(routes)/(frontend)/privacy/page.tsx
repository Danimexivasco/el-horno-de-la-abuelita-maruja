...
export default function PrivacyPage() {
  return (
    <Container className="py-12 prose-base">
      <Headline>Política de privacidad</Headline>
      <div>
        <div>
        ...
        <div>
          ...
          <div className="pl-8">
            <p><strong>a)</strong> La fecha y hora de acceso a la Web, permitiendo saber las horas de más afluencia, y hacer los ajustes precisos para evitar problemas de saturación en nuestras horas punta.</p>
            <p><strong>b)</strong> El número de visitantes diarios de cada sección, permitiendo conocer las áreas de más éxito y aumentar y mejorar su contenido, con el fin de que los usuarios obtengan un resultado más satisfactorio y mejorar el diseño de los contenidos.</p>
            <p><strong>c)</strong> La fecha y hora de la última vez que el usuario visitó el Sitio Web para realizar estudios analíticos y estadísticos sobre el uso que tiene la web.</p>
            <p><strong>d)</strong> Elementos de seguridad que intervienen en el control de acceso a las áreas restringidas.</p>
          </div>
