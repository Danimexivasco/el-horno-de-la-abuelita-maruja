...
export default function CookiesPage() {
  return (
    <Container className="py-12">
      <Headline className="mb-12">Política de Cookies</Headline>
      <div className="grid gap-8">
        ...
        <div>
          ...
          <p>Las <i>cookies</i> no suelen almacenar información sensible sobre usted, como tarjetas de crédito o datos bancarios, fotografías, su DNI o información personal, etc. Los datos que guardan son de carácter técnico, preferencias personales, personalización de contenidos, etc.</p><br />
        ...
        <div>
          ...
          <p>Sí. No sólo eliminar, también bloquear, de forma general o particular para un dominio específico.</p><br />
